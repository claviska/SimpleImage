...
class SimpleImage {
   ...
   * @param bool $borderOffset Offset referring to the edges of the image (default false).
   * @return \claviska\SimpleImage
   */
  public function overlay($overlay, $anchor = 'center', $opacity = 1, $xOffset = 0, $yOffset = 0, $borderOffset = false) {
    // Load overlay image
    ...
    switch($anchor) {
      case 'top left':
        ...
        break;
      case 'top right':
        $x = $this->getWidth() - $overlay->getWidth() + ($borderOffset ? -$xOffset : $xOffset);
        $y = $yOffset;
        break;
      case 'top':
        $x = ($this->getWidth() / 2) - ($overlay->getWidth() / 2) + ($borderOffset ? 0 : $xOffset);
        $y = $yOffset;
        break;
      case 'bottom left':
        $x = $xOffset;
        $y = $this->getHeight() - $overlay->getHeight() + ($borderOffset ? -$yOffset : $yOffset);
        break;
      case 'bottom right':
        $x = $this->getWidth() - $overlay->getWidth() + ($borderOffset ? -$xOffset : $xOffset);
        $y = $this->getHeight() - $overlay->getHeight() + ($borderOffset ? -$yOffset : $yOffset);
      ...
      case 'left':
        $x = $xOffset;
        $y = ($this->getHeight() / 2) - ($overlay->getHeight() / 2) + ($borderOffset ? 0 : $yOffset);
        break;
      case 'right':
        $x = $this->getWidth() - $overlay->getWidth() + ($borderOffset ? -$xOffset : $xOffset);
        $y = ($this->getHeight() / 2) - ($overlay->getHeight() / 2) + ($borderOffset ? 0 : $yOffset);
